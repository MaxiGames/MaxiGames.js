...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(function (option) {
      return option
        .setName("name")
        .setDescription("Name of the person to say hallo to")
        .setRequired(false);
    }),
  execute: function (interaction) {
    return __awaiter(this, void 0, void 0, function () {
      var length, name, numberOfO;
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              interaction.reply({
                content:
                  "Invalid length!!! Length must be between 5 and 2000 :",
                ephemeral: true,
              }),
            ];
          case 1:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              interaction.reply("Hall" + numberOfO + " " + name + "!!!"),
            ];
          case 3:
            _a.sent();
            return [2 /*return*/];
